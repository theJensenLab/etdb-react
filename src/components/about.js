				...
				<div class="row" id="about">
				  <div class="col-sm-6">
				    <div>
				      ...
				      <div id="reddiv"></div>
				      <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p><a class="browse" href="http://www.designing-science-development.com/jensen/search-results/">View challenges <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
				    </div>
				  </div>
				</div>
				<div class="row" id="about">
				...
				<div class="row" id="about">
				  <div class="col-sm-6">
				    <div>
				      <h3>Learning more</h3>
				      <div id="reddiv"></div>
				      <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p><a class="browse" href="http://www.jensenlab.caltech.edu">Jensen Lab <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
				    </div>
				  </div>
				</div>
			</div>
