		...
		return(
			<div>
                ...
                <div className="row challengerow" id="about">
                  ...
                  <p class="note"><b>Note:</b> Because of the "missing wedge" of information in tomograms, it's difficult to detect the cell boundaries at the top and bottom of a tomogram.  If an algorithm can detect the cell membrane along the sides, the best approach may be to simply approximate the top and bottom with an ellipsoid. </p>
                  
                  <p class="note"><b>Also note:</b> Many tomograms capture only part of a cell due to the high magnification; segmentation software should be smart enough to recognize the boundary of the tomogram and realize that it's the edge of the tomogram, not the edge of the cell.</p>
                  </div>
				</div>
                ...
                <div id="longreddiv"></div>
                  ...
                  <h3>2. Software to automatically segment complexes in cells
				      ...
				      <div id="reddiv"></div>			      
                        <p class="goal challenge">The goal is to develop fast algorithms to locate complex structures within the cell such as ribosomes, storage granules, cytoskeletal filaments, filament bundles, chemoreceptor arrays, patterned DNA bundles, flagellar motors, pili, etc.</p>
 
                        <p class="challenge">A good fraction of the interior of a cell is occupied by small proteins and metabolites randomly diffusing about one another, which look like a fairly random texture of different gray-levels in tomograms. The ideal software would automatically detect anything different than that. We already know about many large objects in cells and what they look like, but we also know that there are many more still to be discovered.
 </p>
